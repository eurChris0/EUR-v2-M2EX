...
::EUR.eurStyles <- {
    ...
    basic_4 = {
        // One scale for the whole window: autoScale sizes the widgets, autoScaleAbsolute places
        // them, autoScaleCanvas scales everything the canvases draw. All off 1080p units.
        [::UI.Cap.autoScaleAbsolute]       = 1,
        [::UI.Cap.autoScaleCanvas]      = 1,
        [::UI.Metric.fontSize]        = 12,
        [::UI.Metric.gap]             = 1,
        [::UI.Metric.indent]          = 0,
