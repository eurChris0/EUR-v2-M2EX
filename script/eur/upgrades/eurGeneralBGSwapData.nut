...
::EUR.original_general_units_list <- {}

::EUR.mod_general_units_list <- [
...
::EUR.bgunlock_units_list <- {
}

::EUR.not_increase_guard <- [
    "sauron_1",
    "balrog_1",
    "balrog_2",
    "balrog_3",
