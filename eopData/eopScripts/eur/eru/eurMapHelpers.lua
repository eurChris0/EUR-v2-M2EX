...
custom_maps = {
	[string.format("%d,%d", 121, 380)] = 'longbottom_a',              --(Michel_Derving)
	[string.format("%d,%d", 134, 386)] = 'hobbiton_a',                --(Hobiton)
	[string.format("%d,%d", 144, 375)] = 'hobbit_village_a',          --(Lomgbotom)
	...
	[string.format("%d,%d", 75, 380)] = 'Mithlond',                   --(mithlond)
	--[string.format("%d,%d", 330, 219)] = 'osgiliath_east_repaired_a',  --(Osgiliath_E_GOOD REBUILD)
	--[string.format("%d,%d", 328, 219)] = 'osgiliath_west_repaired_a',  --(Osgiliath_W_GOOD REBUILD)
	--
	[string.format("%d,%d", 330, 219)] = 'osgiliath_east_a',    --(Osgiliath_E_GOOD)
	--[string.format("%d,%d", 330, 219)] = 'osgiliath_east_aev',    --(Osgiliath_E_EVIL)
	--
	[string.format("%d,%d", 186, 333)] = 'osgiliath_west_a',       --(Nord_Tharbad ruined)	
	--[string.format("%d,%d", 186, 333)] = 'North Tharbad',         --(Nord_Tharbad rebuild)	
	--
	[string.format("%d,%d", 188, 333)] = 'osgiliath_east_a',       --(Sud_Tharbad ruined)
	--[string.format("%d,%d", 188, 333)] = 'South Tharbad',         --(Sud_Tharbad rebuild)
	--
